...
if __name__ == '__main__':
    ...
    logging.basicConfig(filename='log/san_78_nogrid0.9.log', filemode='w',
                        format='[%(asctime)s] - %(module)s.%(funcName)s.%(lineno)d - %(levelname)s - %(message)s',
                        level=logging.INFO)
    train_test='../data/78train_test_san0.93.pkl'
...
#             cn,cn_node_weight,cn_edge_weight= get(wg,i,j)
            ...
            net.add_edge(u,v)
            trainvector.append([u,v,sancn,sancn_node,sancn_edge,sanaa,sanaa_node,sanaa_edge,path_len[u][v],rwr,wrwr,target])
        ...
        for [u,v,target] in test:
            ...
            testvector.append([u,v,sancn,sancn_node,sancn_edge,sanaa,sanaa_node,sanaa_edge,path_len[u][v],rwr,wrwr,target])
