...
def linktest78file():
    ...
    pkl_file.close()
    alphas = [0.93]
#     alphas = [1.*i/10 for i in range(1,11)]
    nows=[]
    edges=[]
    for a in alphas:
#         'jul3nets.pkl0.110sanrwrbk'
        ...
        pklfile='../data/jul3nets.pkl'+str(a)+'20snrwr'
...
if __name__ == '__main__':
    logging.basicConfig(filename='log/snrwr_alpha_20.txt', filemode='w',
